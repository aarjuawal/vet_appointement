<?php
$mysqli = new mysqli('localhost', 'root', '', 'pasavet');
if(isset($_GET['date'])){
    $date = $_GET['date'];
...
if(isset($_POST['submit'])){
    ...
    if($stmt->execute()){
        ...
        if($result->num_rows>0){
            ...
            $stmt = $mysqli->prepare("INSERT INTO appointments (customer_name, pet_name, date, timeslot, reason) VALUES (?,?,?,?,?)");
    $stmt->bind_param('sssss', $customer_name, $pet_name, $date, $timeslot ,$reason);
    $stmt->execute();
            ...
            <div class="col-md-12">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" name="pet_name" class="form-control">
                    </div>
                    <div class="form-group">
