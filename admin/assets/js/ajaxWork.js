...
function sizeDelete(id){
    $.ajax({
        ...
        data:{record:id},
        success:function(data){
            alert('delete doctor information');
            $('form').trigger('reset');
            showSizes();
        }
    });
...
function customerDelete(id){
    $.ajax({
        ...
        data:{record:id},
        success:function(data){
            alert('delete customer information');
            $('form').trigger('reset');
            showCustomers();
        }
    });
...
function updateVariations(){
    ...
    var d_contactno = $('#d_contactno').val();
    var fd = new FormData();
    fd.append('ID', ID);
    fd.append('d_name', d_name);
    fd.append('d_address', d_address);
    fd.append('d_contactno', d_contactno);
...
function updateCustomer(){
    ...
    $.ajax({
      url:'./controller/updateCustomer.php',
      method:'post',
      data:fd,
      processData: false,
      contentType: false,
